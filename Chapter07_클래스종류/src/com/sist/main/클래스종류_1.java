 ...
 *                      -------------------
 *                          생략이 가능
 *                      (public static fianl) int B=10;   => 상수    
 *                  -------------------------------------
 *                      생성자는 존재하지 않는다
 *                      매서드 => 선언만 되어 있다
 *                      public abstract 리턴형 메서드명(매개);
 *                      --------------- 생략이 가능
 *                      *** 인터페이스는 모든 변수/메서드가 public
 *                  -------------------------------------
 *                      jdk1.8  추가
 *                      => 구현된 메서드
 *                      public default 리턴형 메서드명()
 *                             -------
 *                      {
 *                      }
 *                  -------------------------------------
