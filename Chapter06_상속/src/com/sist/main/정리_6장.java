 ...
 *                      
 *              *** 인스턴스 메서드, 생성자
 *                  =>  인스턴스변수, 메서드, static변수, static메서드
 *                      사용이 가능
 *              *** static 메서드, static블록
 *                  => static변수, static메서드만 사용이 가능
 *                  => 인스턴스 사용시에는 반드시 객체 생성 후 사용
 *                  => 제약이 많다 : 공통 사용 : 한글변환, 데이터를 브라우저 전송
 *         }
 *                     
 *         접근지정어
