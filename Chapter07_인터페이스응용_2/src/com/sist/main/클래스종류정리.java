 ...
 *              | 자바포함 JSP 포함       | Jqeury, NodeJS, VueJS
 *               
 *      => 상속
...
public class 클래스종류정리 {
    ...
    public static void main(String[] args) {
        ...
        if (obj instanceof Object)          // instanceof 는 클래스와 클래스의 크기를 비교할 때 사용
        {
            System.out.println("obj 는 Object클래스 객체");
        }
