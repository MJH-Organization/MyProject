 ...
 *             => 복구할 수 없다 / 정상수행 / 시스템 자체 처리
 *             => 라이브러리 메서드 => 반드시 예외처리후 사용해야 된다
 *                ----------------------------- try~catch
 *             => 선언방식
